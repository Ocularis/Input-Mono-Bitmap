...
# Excerpted from https://github.com/FontBureau/fbOpenTools/blob/master/ShowMouseCoordinates/Show%20Mouse%20Coordinates.roboFontExt/lib/showMouseCoordinates.py
